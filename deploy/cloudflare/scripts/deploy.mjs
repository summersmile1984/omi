...
function ensureResources() {
  ...
  if (!r2Exists("omi-cf-chat-files-staging"))
    run("npx", ["wrangler", "r2", "bucket", "create", "omi-cf-chat-files-staging"]);
  ...
  if (!r2Exists("omi-cf-desktop-updates-staging"))
    run("npx", [
      "wrangler",
      "r2",
      "bucket",
      "create",
      "omi-cf-desktop-updates-staging",
    ]);

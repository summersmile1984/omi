...
from persona_routes import get_persona_initial_message  # noqa: E402
...
def signed_headers(secret="persona-secret", uid="persona-user"):
...
def make_env(ai=None, secret="persona-secret"):
    return type(
        "Env",
        (),
        {

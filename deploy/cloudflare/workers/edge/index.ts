...
app.put("/v1/workstreams/:workstreamId/checkpoints/:runtimeId", proxyAuthenticatedCore);
app.patch("/v1/workstreams/:workstreamId/artifacts/:artifactId/status", proxyAuthenticatedCore);

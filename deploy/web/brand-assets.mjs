...
export function generateWebAssets(brandId, input, publicDirectory) {
  ...
  if (brandId === "omi-upstream")
    return { mode: "upstream", inputs: {}, outputs: {} };
  ...
  // Presentation consumers use logo.png; do not publish the retired wordmark.
  rmSync(resolve(publicDirectory, "omi-white.webp"), { force: true });
  return {
    mode: "manifest",
    inputs: Object.fromEntries(
      Object.entries(decoded).map(([role, { png, ...receipt }]) => [
        role,
        receipt,
      ])
    ),

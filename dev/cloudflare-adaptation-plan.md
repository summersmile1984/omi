...
authenticated staging smoke          # required release credential plus Web→Edge conversation/enabled-app/memory reads and existing D1/API boundaries → unit verified; live rerun pending deploy

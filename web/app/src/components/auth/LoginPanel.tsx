...
export function LoginPanel({ isOpen, onClose }: LoginPanelProps) {
  const { socialProviders, signInWithGoogle, signInWithApple } = useAuth();
                ...
                <div className="space-y-3">
                  {isBetterAuthEnabled && (
                    <button
                      ...
                      className="w-full rounded-xl bg-white px-4 py-3.5 font-medium text-gray-900 shadow-lg shadow-white/5 transition-all hover:bg-gray-100"
                    >
                      Continue with email
                    </button>
                  )}
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="px-3 bg-[#0B0F17] text-gray-500">
                      {isBetterAuthEnabled
                        ? 'Secure sign-in powered by Better Auth'

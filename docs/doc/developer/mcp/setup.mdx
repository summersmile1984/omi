...
For the complete operator workflow from a terminal through a PC Claude/Codex client, see the
[terminal-to-PC Claude/Codex runbook](../../../runbooks/terminal-to-pc-claude-codex.md).

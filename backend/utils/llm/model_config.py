...
# keeping model/provider ownership in one place. The constants above are the
# single declaration; the route helpers below are defined after the capability
# metadata so they can use the complete feature inventory.
